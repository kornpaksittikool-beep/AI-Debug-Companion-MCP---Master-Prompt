...
เอกสารนี้สรุปแบบภาษาคนว่า MCP ตัวนี้ทำอะไรได้บ้าง ณ Phase 22 โดยเน้นความสามารถที่ใช้ช่วยงานพัฒนา software จริง ไม่ใช่รายละเอียดเชิง implementation
...
- สำรวจโครงสร้าง repository แบบจำกัดขอบเขต
...
- ยังไม่ได้เป็น exact Codex billing token จริง
...
ค่าที่ควรเห็นจาก Phase 22:

- `platform.health` เป็น `ok`
- phase เป็น `phase-23-codex-auto-use-integration`
- จำนวน tools ทั้งหมดเป็น `82`
