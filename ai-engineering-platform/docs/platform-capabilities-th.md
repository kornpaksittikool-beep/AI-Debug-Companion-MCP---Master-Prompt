...
เอกสารนี้สรุปแบบภาษาคนว่า MCP ตัวนี้ทำอะไรได้บ้าง ณ Phase 30 โดยเน้นความสามารถที่ใช้ช่วยงานพัฒนา software จริง ไม่ใช่รายละเอียดเชิง implementation
...
ค่าที่ควรเห็นจาก Phase 30:

- `platform.health` เป็น `ok`
- phase เป็น `phase-30-summary-search-result-caps`
